...
contract PrepareAttestationRequest is Script {
    ...
    string public apiUrl =
        "https://42a4fff699b8.ngrok-free.app/get-num-completed";
    string public httpMethod = "GET";
    // Defaults to "Content-Type": "application/json"
    string public headers = '{\\"Content-Type\\":\\"application/json\\"}';
    string public queryParams = '{\\"course_id\\":\\"2\\"}';
    string public body = "{}";
    string public postProcessJq = "{num_completed: .num_completed}";
    string public abiSignature =
        '{\\"components\\": [{\\"internalType\\": \\"uint256\\", \\"name\\": \\"num_completed\\", \\"type\\": \\"uint256\\"}],\\"name\\": \\"task\\",\\"type\\": \\"tuple\\"}';
...
contract InteractWithContract is Script {
    function run() external {
        ...
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY");
        vm.startBroadcast(deployerPrivateKey);
        ICreatorNFT creatorNFT = ICreatorNFT(_address);
        creatorNFT.updateMilestone(proof);
        vm.stopBroadcast();
    }
}
