    ...
    <div className="overflow-y-auto flex-1 py-2">
      {course.modules.map(module => <div key={module.id} className="mb-1">
        ...
        {expandedModules[module.id] && <div className="ml-6 mr-2 mt-1 mb-2 space-y-1">
          ...
          {module.quiz && <button
            onClick={() => onQuizSelect(module.id, module.quiz!.id)} className="w-full px-3 py-2 text-sm rounded-md flex items-center text-left text-emerald-700 hover:bg-stone-50">
