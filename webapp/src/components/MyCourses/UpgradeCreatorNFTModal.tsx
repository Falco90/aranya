...
export default function UpgradeNFTModal({
    ...
    useEffect(() => {
        ...
        const runServerFlow = async () => {
            try {
                const res = await fetch("/api/upgrade-creator-nft", {
                    method: "POST",
    ...
    const handleConfirmTransaction = async () => {
        ...
        if (!nftAddress) {
            setError(
                "Missing Creator NFT address. Set NEXT_PUBLIC_COURSE_MANAGER_ADDRESS."
            );
            return;
        }
        if (!serverData) {
                ...
                <div className="p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-stone-600 text-sm">
                            Your tree is growing. This may take a few minutes.
                        </p>
                    </div>
                    ...
                    <div className="space-y-6">
                        <Step
                            ...
                            description="Creating attestation for your tree..."
                            icon={FileTextIcon}
                            stepKey="attestation"
                        />
                        <Step
